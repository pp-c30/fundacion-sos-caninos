...
class PerroController {
    listarPerro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let perro = yield base.query('select * from perro');
    ...
    guardarPerro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const base = yield database_1.con();
            let perro = req.body;
            yield base.query("insert into perro set ?", [perro]);
    ...
    eliminarPerro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield base.query("delete from perro where id_perro =?", [id]);
    ...
    actualizarPerro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield base.query("update perro set ? where id_perro = ?", [nuevos_datos_perro, id]);
    ...
    obtenerPerro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const base = yield database_1.con();
            let id = req.params.id;
            let unPerro = yield base.query("select * from perro where id_perro = ?", [id]);
